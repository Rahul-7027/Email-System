...
<body background="images/1.jpg">
	...
	<tr><td align ="center" ><h2>To</h2></td><td align="center"><h2>Subject</h2></td><td align="center"><h2>Body</h2></td><td align="center"><h2>Date Time</h2></td></tr>
	<%while(it.hasNext()){ 
	ComposeMailBean cb=it.next();
	
	%>
	<tr><td><%=cb.getToName()%> </td><td ><font color="blue"><%=cb.getSubject() %></font></td><td><%=cb.getBody() %></td><td><%=cb.getTime() %></td></tr>
	<%} %>
	</table> 
